...
function printLayer(layer){
	var genrator=window.open(",name,");
	var layerTxt=document.getElementById(layer);
	genrator.document.write(layerTxt.innerHTML.replace("Print"));
	genrator.document.close()
	genrator.print()
	genrator.close()
}
